class Course
  ...
  # def course_name#ACCESOR
  #   @course_name
  # end
  #
  # def course_name=(new_name)#ACCESOR
  #   @course_name = new_name
  # end

  def add_student(student)#WRITER
    @students << student
  end
...
class Student
  ...
  # end
  #
  # def name=(new_name)#ACESOR
  #   @name = new_name
  # end

  # def last_name#ACCESOR
  #   @last_name
  # end
  #
  # def last_name=(new_last_name)#ACCESOR
